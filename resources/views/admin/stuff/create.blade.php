            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Create Stuff</li>
                    </ul>
                </div>
            ...
            <div class="card-body">
                <div class="card-title">
                    ...
                    <div class="col-xl-12 mx-auto">
                        <h6 class="mb-0 text-uppercase">Create A Stuff</h6>
                        <hr>
                                    ...
                                    <div class="border p-4 rounded">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="name" id="" class="form-control" value="{{ old('name') }}" placeholder="Enter Stuff Name">
                                                @if($errors->has('name'))
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="email" id="" class="form-control" value="{{ old('email') }}" placeholder="Enter Stuff Email">
                                                @if($errors->has('email'))
