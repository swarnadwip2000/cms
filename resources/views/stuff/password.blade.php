        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('stuff.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('stuff.profile') }}">Profile</a></li>
                    ...
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12 col-lg-5 border-right">
                                <form class="row g-3" action="{{route('stuff.password.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
