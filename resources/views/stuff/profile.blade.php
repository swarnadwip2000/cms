                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            {{-- <li class="breadcrumb-item"><a href="{{route('stuff.dashboard')}}"><i class='bx bx-home-alt'></i></a>
                            </li> --}}
                            ...
                            <div class="col-12 col-lg-7 border-right">
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="ms-md-4 flex-grow-1">
                                        ...
                                        <p class="mb-0 text-muted">Stuff</p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12 col-lg-5 border-right">
                                                    <form class="row g-3" action="{{route('stuff.profile.update')}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="col-12">
