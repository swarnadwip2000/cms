        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('stuff.profile') }}">My Profile</a>
                    <a class="dropdown-item" href="{{ route('stuff.password') }}">Change Password</a>
                    <a class="dropdown-item" href="{{ route('stuff.logout') }}">Logout</a>
                </div>
            </li>
        </ul>
